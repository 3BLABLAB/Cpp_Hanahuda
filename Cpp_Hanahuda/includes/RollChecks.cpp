...
void CheckRolls(const HudaFlagTable& Mochihuda, std::vector <String>& Rolls) {
	Goko(Mochihuda,Rolls);
	HanamiDeIppai(Mochihuda,Rolls);
	TsukimiDeIppai(Mochihuda,Rolls);
	Inoshikacho(Mochihuda,Rolls);
	Akatan(Mochihuda,Rolls);
	Aotan(Mochihuda,Rolls);
	Tane(Mochihuda,Rolls);//得点変動
	Tann(Mochihuda,Rolls);//得点変動
	Kasu(Mochihuda,Rolls);//得点変動
}
...
void Inoshikacho(const HudaFlagTable& Mochihuda, std::vector <String>& Rolls) {
	if (Mochihuda[5][0] && Mochihuda[6][0] && Mochihuda[9][0])
	{
...
void Akatan(const HudaFlagTable& Mochihuda, std::vector <String>& Rolls) {
	if (Mochihuda[0][1] && Mochihuda[1][1] && Mochihuda[2][1])
	{
		Rolls[4] = U"Akatan";
	}
}
...
void Aotan(const HudaFlagTable& Mochihuda, std::vector <String>& Rolls) {
	if (Mochihuda[5][1] && Mochihuda[8][1] && Mochihuda[9][1])
	{
		Rolls[5] = U"Aotan";
	}
}
